...
// @CreatesAnnotation(value = AnnotationTypes.ANNOTATION_TYPE_LANGUAGE, bounds =
// ContentBounds.class)
public class DetectLanguage extends AbstractTextProcessor {
  ...
  public void process(Text text) {
    ...
    TextObject textObject = detectLanguageSettings.getTextObjectFactory().forText(text.getData());
