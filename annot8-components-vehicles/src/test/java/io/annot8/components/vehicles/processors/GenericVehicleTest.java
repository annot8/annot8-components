...
public class GenericVehicleTest {
  ...
  public void testCreation(){
    ...
    Processor processor = genericVehicle
  ...
  public void testSimple(){
    testSingleMatch("Natalie was seen driving an old rusty, blue boat.", "old rusty, blue boat", "maritime");
  }
  ...
  private void testSingleMatch(String sentence, String match, String subtype){
    ...
    assertEquals(1, content.getAnnotations().getByType(AnnotationTypes.ANNOTATION_TYPE_VEHICLE).count());

    Annotation a = content.getAnnotations().getByType(AnnotationTypes.ANNOTATION_TYPE_VEHICLE).findFirst().get();
    assertNotNull(a);
