...
public class LanguageDetectionTest {
  ...
  public void testEnglish(){
    ...
    test("The fog had swallowed up the house, and the house had submitted." +
        ...
        " the rattle of a cab, the barking of a dog, isolated sounds that ascended, plaintively, from a lost, a submerged world.", "eng");
  }

  @Test
  public void testGerman(){
    //Content taken from: http://www.gutenberg.org/cache/epub/6004/pg6004.txt
    test("Das Schlafzimmer eines jungen Mädchens in Bulgarien, in einer kleinen Stadt nahe dem Dragomanpaß. " +
        ...
        "Das Gebirge scheint ganz nahe, obwohl es in Wirklichkeit meilenweit entfernt ist.", "deu");
  }

  @Test
  public void testGreek(){
    //Content taken from: http://www.gutenberg.org/files/36300/36300-0.txt
    test("Τη λεπτή, την χαριτωμένη αυτή ομιλία έκαναν ανάμεσό τους — ποιος ήθελε το πιστέψη ποτέ — " +
        ...
        "όλο το εναντίο, ένα παιχνίδι μαλακό, αθόρυβο, όλως διόλου ακίνδυνο, σαν να έπαιζαν το τόπι τα δυο υποκείμενα.", "ell");
  }
  ...
  private void test(String text, String expectedLanguage){
    ...
    List<Annotation> l = content.getAnnotations().getByBounds(ContentBounds.class).collect(Collectors.toList());
    ...
    assertEquals(expectedLanguage, l.get(0).getProperties().get(PropertyKeys.PROPERTY_KEY_LANGUAGE, String.class).orElse(null));
