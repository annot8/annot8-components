...
public class ItemPropertyFromProperty extends AbstractProcessorDescriptor<ItemPropertyFromProperty.Processor, ItemPropertyFromProperty.Settings> {

  @Override
  protected Processor createComponent(Context context, Settings settings) {
    return new Processor(settings.getSourceKey(),
